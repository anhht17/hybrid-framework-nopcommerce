...
public class Level_02_Register_Apply_Base_Page_II {
	WebDriver driver;
	...
	public void TC_02_Register_Invalid_Email() {
		...
		basePage.sendkeysToElement(driver,"//input[@id='FirstName']", "Tam Anh");
		basePage.sendkeysToElement(driver,"//input[@id='LastName']", "Hoang");
		basePage.sendkeysToElement(driver,"//input[@id='Email']", "anhht.com");
	...
	public void TC_04_Register_Existed_Email() {
		...
		basePage.sendkeysToElement(driver,"//input[@id='FirstName']", "Tam Anh");
		basePage.sendkeysToElement(driver,"//input[@id='LastName']", "Hoang");
		basePage.sendkeysToElement(driver,"//input[@id='Email']", "automationfc.vn@gmail.com");
		basePage.sendkeysToElement(driver,"//input[@id='Password']", "123456");
		basePage.sendkeysToElement(driver,"//input[@id='ConfirmPassword']", "123456");
